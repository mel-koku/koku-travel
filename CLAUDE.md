...
- **Festival Calendar**: `src/data/festivalCalendar.ts` -- ~60 festivals with `isApproximate` flag for entries with shifting dates (cherry blossom peaks, weekend-based matsuri, etc.).
