...
const GUIDANCE_TYPE_CATEGORIES: Partial<Record<GuidanceType, string[]>> = {
  ...
  cultural_context: ["temple", "shrine", "culture", "landmark", "historic_site", "castle", "museum", "craft"],
  etiquette: ["temple", "shrine", "restaurant", "onsen", "wellness", "culture", "craft"],
  budget: ["restaurant", "shopping", "entertainment", "market", "cafe", "craft"],
  practical: [
    "restaurant", "cafe", "bar", "market", "shopping", "temple", "shrine",
    "museum", "entertainment", "onsen", "wellness", "landmark", "park",
    "culture", "historic_site", "castle", "craft",
  ],
  seasonal: ["nature", "park", "garden", "beach", "shrine", "temple", "viewpoint"],
  environmental: ["nature", "park", "garden", "beach"],
  photography: ["shrine", "temple", "viewpoint", "landmark", "garden", "nature", "castle", "park", "craft"],
  accessibility: ["museum", "temple", "shrine", "park", "restaurant", "entertainment", "landmark"],
  family: ["park", "entertainment", "museum", "aquarium", "zoo", "beach", "nature", "craft"],
