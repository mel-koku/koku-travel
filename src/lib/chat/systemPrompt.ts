...
- **importVideoLocation**: Use when a user pastes a YouTube, TikTok, or Instagram video URL. Automatically identifies the Japan location in the video and adds it to the database. After import, offer to save it to their saved places.
