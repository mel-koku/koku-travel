          ...
          {locations.slice(0, 5).map((location, i) => {
            ...
            return (
              <ScrollReveal
                ...
                delay={0.1 + i * 0.08}
                className={cn(
                  "h-full rounded-lg border border-border bg-surface shadow-[var(--shadow-card)] transition-[border-color,box-shadow] duration-300 hover:border-foreground/30 hover:shadow-[var(--shadow-elevated)]",
