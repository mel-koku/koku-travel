      ...
      {regionCities.length > 6 && (
        <div className="relative mt-2">
          ...
          <input
            ...
            className="h-12 w-full rounded-md border border-border bg-background pl-8 pr-3 text-base text-foreground placeholder:text-stone focus:outline-none focus:ring-1 focus:ring-brand-primary"
            autoComplete="off"
          />
        </div>
      )}
