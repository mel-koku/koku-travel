  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div className="relative">
          <input
            ...
            disabled={isLoading}
            className="h-12 w-full rounded-md border border-border bg-background px-3 pr-10 text-base focus:outline-none focus:ring-2 focus:ring-brand-primary disabled:bg-surface disabled:cursor-not-allowed"
            role="combobox"
      ...
      {showDropdown && filteredAirports.length > 0 && (
        <div
          ref={dropdownRef}
          className="relative z-50 rounded-lg border border-border bg-background shadow-[var(--shadow-elevated)] max-h-60 overflow-auto"
          role="listbox"
          id={listboxId}
        >
