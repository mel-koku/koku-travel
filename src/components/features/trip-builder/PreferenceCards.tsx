    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
      ...
      >
        <textarea
          ...
          className="w-full rounded-md border border-border px-3 py-2 text-sm placeholder:text-stone focus:border-brand-primary focus:outline-none focus:ring-1 focus:ring-brand-primary"
          rows={4}
