      ...
      <div className="relative">
        ...
        {open && (
          <div
            ...
            className="absolute z-50 mt-2 w-full rounded-2xl border border-border bg-background p-2 shadow-lg ring-1 ring-charcoal/10 focus:outline-none max-h-80 overflow-y-auto"
            tabIndex={-1}
          >
