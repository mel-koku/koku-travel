        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-2 sm:gap-3 py-3">
            ...
            >
              ...
              <button
                type="submit"
                className="absolute -right-px -top-px -bottom-px flex w-12 items-center justify-center rounded-l-none rounded-r-xl bg-brand-primary text-white hover:bg-brand-primary/90 active:scale-[0.98] transition"
                aria-label="Search"
              >
