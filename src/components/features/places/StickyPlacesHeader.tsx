...
export function StickyPlacesHeader({
  ...
  const buttonClassName = cn(
    "flex min-h-[44px] items-center gap-2 rounded-full border border-brand-primary bg-background px-4 py-2 text-xs font-semibold text-brand-primary shadow-[var(--shadow-sm)] transition-all hover:bg-surface hover:shadow-[var(--shadow-card)]"
  );
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center gap-2 py-3 pointer-events-auto">
          ...
          <Link
            href="/dashboard"
            className="hidden sm:flex min-h-[44px] items-center gap-2 rounded-full border border-border bg-background px-4 py-2 text-xs font-semibold text-foreground-secondary shadow-[var(--shadow-sm)] transition-all hover:border-brand-primary hover:text-brand-primary hover:shadow-[var(--shadow-card)]"
          >
            Dashboard
          </Link>
        </div>
