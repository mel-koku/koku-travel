  ...
  return (
    <div className="relative">
      ...
      <input
        id="places-search"
        type="text"
        className="w-full min-h-[44px] rounded-lg border border-border bg-background text-foreground placeholder-stone pl-9 pr-10 text-base shadow-[var(--shadow-sm)] focus:outline-none focus:ring-2 focus:ring-brand-primary focus:shadow-[var(--shadow-card)]"
