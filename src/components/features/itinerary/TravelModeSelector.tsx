...
export function TravelModeSelector({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 top-full z-50 mt-1 w-[min(14rem,90vw)] rounded-lg border border-border bg-background shadow-[var(--shadow-elevated)] ring-1 ring-black/5">
          <div className="p-1">
            {TRAVEL_MODES.map((option) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center justify-between gap-2 rounded-lg px-2 py-1.5 text-left text-xs transition",
                    isCurrentMode
