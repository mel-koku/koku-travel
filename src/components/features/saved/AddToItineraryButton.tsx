  ...
  if (!trips.length) {
    return (
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-stone">Create a trip to begin adding your saved places.</p>
      </div>
    );
  }
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            <label htmlFor="saved-trip-select" className="text-sm font-medium text-foreground-secondary">
              Itinerary
            </label>
            <Select
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="saved-day-select" className="text-sm font-medium text-foreground-secondary">
              Day
            </label>
            <Select
              id="saved-day-select"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="saved-time-select" className="text-sm font-medium text-foreground-secondary">
              Time of day
            </label>
            <Select
              id="saved-time-select"
...
function addLocationToItinerary({
  ...
  while (days.length <= dayIndex) {
    days.push({
      id: `saved-day-${days.length}-${Date.now().toString(36)}`,
