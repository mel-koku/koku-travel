...
const SUGGESTION_POOLS: Record<AskYukuContext, StarterSuggestion[]> = {
  ...
  "trip-builder": [
    ...
    { text: "Which region beyond Kansai is worth the detour?", timeOfDay: "any", tripPhase: "planning" },
    { text: "Where do I go for depth over crowds?", timeOfDay: "any", tripPhase: "planning" },
  ...
  default: [
    { text: "What's worth visiting beyond Kyoto and Tokyo?", timeOfDay: "any", tripPhase: "planning" },
    { text: "Where in Japan feels extraordinary and quiet?", timeOfDay: "any", tripPhase: "planning" },
    ...
    { text: "Do I need a JR Pass?", timeOfDay: "any", tripPhase: "planning" },
    { text: "Is Tohoku worth building a trip around?", timeOfDay: "any", tripPhase: "planning" },
