        ...
        >
          ...
          <div className="flex flex-col justify-center p-6 sm:p-8">
            ...
            <button
              ...
              className="mt-4 inline-flex min-h-11 items-center self-start py-2 text-left text-sm font-medium text-brand-primary transition-colors hover:text-brand-secondary group-hover:text-brand-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:rounded-md"
            >
              View details
