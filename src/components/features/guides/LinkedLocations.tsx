...
function LocationMiniCard({ location }: { location: Location }) {
  ...
  return (
    <Link
      ...
      className="group flex gap-3 rounded-lg border border-border bg-background p-3 transition-all hover:shadow-md hover:border-sand"
    >
      {/* Image */}
      ...
      <div className="flex flex-col justify-center min-w-0">
        <h3 className="font-medium text-charcoal line-clamp-1 group-hover:text-brand-primary transition-colors">
          {location.name}
        </h3>
        ...
        <div className="flex items-center gap-2 mt-1">
          <span className="text-xs font-medium capitalize bg-surface text-warm-gray px-2 py-0.5 rounded-full">
            {location.category}
          </span>
