  ...
  return createPortal(
    <div className="fixed inset-0 z-1200 overflow-y-auto">
      <div
        ref={backdropRef}
        className={cn(
          "flex min-h-full items-start justify-center bg-charcoal/50 backdrop-blur-sm px-4 py-4 sm:py-8 md:py-12",
          className,
        )}
        role="presentation"
      ...
      >
        <div
          ref={panelRef}
          className={cn(
            "relative w-full max-w-lg rounded-lg bg-background p-6 shadow-[var(--shadow-elevated)] outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2",
