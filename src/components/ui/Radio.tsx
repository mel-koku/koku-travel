  ...
  ({ label, description, className, containerClassName, disabled, id, ...rest }, ref) => {
    ...
    return (
      <label
        htmlFor={inputId}
        className={cn(
          "group flex min-h-[44px] cursor-pointer items-start gap-3 rounded-lg border border-transparent px-4 py-3 transition focus-within:outline-none focus-within:ring-2 focus-within:ring-brand-primary focus-within:ring-offset-2",
