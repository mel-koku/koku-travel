    ...
    <div className="w-full">
      ...
      >
        <SelectTrigger
          id={id}
          className={cn(
            "h-12 rounded-md border-border bg-background text-base shadow-[var(--shadow-sm)] focus:ring-2 focus:ring-brand-primary",
