  ...
  return (
    <Magnetic strength={0.2}>
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center lg:hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary rounded-lg"
