          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 py-2">
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-[var(--border)] bg-white pl-9 pr-10 py-2 text-sm text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 transition"
              />
              <button
                type="submit"
                title="Search"
                className="absolute -right-px -top-px -bottom-px flex w-10 items-center justify-center rounded-l-none rounded-r-xl bg-[var(--primary)] text-white hover:opacity-90 active:scale-[0.98] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/30"
                aria-label="Search"
              >
            ...
            {mapAvailable && onViewModeChange && (
              <div className="flex shrink-0 rounded-xl border border-[var(--border)] overflow-hidden">
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 px-3 py-2 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/30",
                    viewMode === "grid"
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-1.5 rounded-xl border px-3 py-2 text-sm font-medium transition shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/30",
                activeFilterCount > 0
