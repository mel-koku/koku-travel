        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {savedLocations.length === 0 ? (
            <div className="flex flex-col items-center py-24 text-center">
              ...
              <Link
                href="/b/places"
                className="mt-6 inline-flex h-11 items-center justify-center rounded-xl bg-[var(--primary)] px-6 text-sm font-medium text-white active:scale-[0.98] transition-all hover:shadow-[var(--shadow-elevated)] hover:brightness-110"
              >
                Start exploring
              </Link>
            </div>
