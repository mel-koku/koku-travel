...
type ExperienceHighlightBProps = {
  value: {
...
function getAccent(highlightType: string): string {
...
export function ExperienceHighlightBlockB({ value }: ExperienceHighlightBProps) {
  const config = HIGHLIGHT_CONFIG[value.highlightType] || HIGHLIGHT_CONFIG.key_moment;
  const accent = getAccent(value.highlightType);
