...
export function AskKokuPanelB({ onClose, context, tripData }: AskKokuPanelProps) {
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[60] flex flex-col bg-white pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left,0px)] pr-[env(safe-area-inset-right,0px)] lg:inset-auto lg:bottom-24 lg:right-6 lg:h-[600px] lg:w-[400px] lg:rounded-2xl lg:shadow-[var(--shadow-depth)] lg:pt-0 lg:pb-0 lg:pl-0 lg:pr-0"
      data-lenis-prevent
    >
      {/* Header */}
