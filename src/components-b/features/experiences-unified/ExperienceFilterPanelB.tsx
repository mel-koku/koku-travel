...
type ExperienceFilterPanelBProps = {
  isOpen: boolean;
  onClose: () => void;
  // Experience type
  ...
  // Craft type (workshop sub-filter)
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
              ...
              {/* Experience Type */}
              <FilterSectionB label="Type" activeCount={selectedType ? 1 : 0} onClear={() => onTypeChange(null)}>
              ...
              {/* Craft Type — only when workshop selected */}
