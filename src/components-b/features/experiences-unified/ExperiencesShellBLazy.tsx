...
const ExperiencesShellB = dynamic(
  () => import("./ExperiencesShellB").then((m) => ({ default: m.ExperiencesShellB })),
  {
    ssr: false,
    loading: () => (
      <div className="min-h-[100dvh] bg-[var(--background)]">
        <div className="flex flex-col items-center justify-center py-24 px-6">
          ...
          <p className="mt-3 text-sm text-[var(--muted-foreground)]">Loading experiences&hellip;</p>
        </div>
        <div className="px-4">
...
export function ExperiencesShellBLazy() {
  return (
    <ErrorBoundary>
      <ExperiencesShellB />
    </ErrorBoundary>
