    ...
    >
          ...
          >
            {viewMode === "discover" ? (
              <DiscoverMapB
                ...
                onHoverChange={discover.setHighlightedLocationId}
      ...
      <div className="flex flex-col lg:h-full lg:flex-row lg:gap-0">
        ...
        <div className="flex flex-col lg:w-1/2">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  {!isReadOnly && tripId && !isUsingMock && (
                    <div
                      className="flex h-9 shrink-0 items-center rounded-xl border p-0.5"
          ...
          {/* Day Trip Banner */}
          {dayTripSuggestions && dayTripSuggestions.length > 0 && viewMode === "timeline" && (
