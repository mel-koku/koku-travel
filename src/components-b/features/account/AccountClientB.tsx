  ...
  return (
    <form className="grid grid-cols-1 gap-4" onSubmit={sendMagicLink}>
      ...
      <button
        type="submit"
        disabled={supabaseUnavailable}
        className="h-12 rounded-xl bg-[var(--primary)] px-4 text-sm font-medium text-white shadow-[var(--shadow-sm)] transition-all hover:shadow-[var(--shadow-elevated)] hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
      >
