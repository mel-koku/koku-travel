        ...
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <button
              type="submit"
              disabled={!supabase}
              className="w-full h-12 rounded-xl bg-[var(--primary)] text-sm font-semibold text-white shadow-[var(--shadow-sm)] transition-all hover:shadow-[var(--shadow-elevated)] hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
            >
