...
type FeaturedExperiencesCProps = {
...
export function FeaturedExperiencesC({
  experiences,
  content,
}: FeaturedExperiencesCProps) {
          ...
          <div className="mt-12 grid grid-cols-1 gap-px border border-[var(--border)] bg-[var(--border)] sm:grid-cols-2 lg:mt-16 lg:grid-cols-3">
            {experiences.map((exp, i) => {
              ...
              return (
                ...
                >
                  <Link href={`/c/experiences/${exp.slug}`} className="block">
                    ...
                    <div className="p-5 lg:p-6">
                      <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)]">
                        {exp.city || exp.region || exp.experienceType}
                      </p>
                      <h3
