...
export type EntryPointStepCProps = {
  sanityConfig?: TripBuilderConfig;
};

export function EntryPointStepC({ sanityConfig }: EntryPointStepCProps) {
        ...
        <div className="mx-auto w-full max-w-md">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center bg-[var(--primary)]/10 text-[var(--primary)]">
                  ...
                  <button
                    type="button"
                    onClick={handleClear}
                    className="px-4 py-2 text-xs font-bold uppercase tracking-[0.1em] text-[var(--muted-foreground)] transition-colors hover:bg-[var(--surface)] hover:text-[var(--foreground)]"
                  >
                    Change
                  </button>
                </div>
                ...
                <div className="mt-3 flex items-center gap-3 border-t border-[var(--border)] pt-3">
                  ...
                  <div className="flex flex-1 items-center gap-2">
                    <label className="whitespace-nowrap text-xs text-[var(--muted-foreground)]">Landing at</label>
                    <TimePickerC
                ...
                <div className="mt-6">
                    ...
                    <button
                      ...
                      className={`flex-1 border px-3 py-2.5 text-sm font-medium transition-all ${
                        sameAsEntry
                          ...
                          : "border-[var(--border)] bg-[var(--background)] text-[var(--muted-foreground)] hover:border-[var(--primary)]/30 hover:text-[var(--foreground)]"
                      }`}
                    >
                      Same airport
                    </button>
                  ...
                  <AnimatePresence>
                    {!sameAsEntry && (
                      ...
                      >
                        {data.exitPoint ? (
                          <div className="mt-3 border border-[var(--border)] bg-[var(--background)] p-4">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <div className="flex h-10 w-10 items-center justify-center bg-[var(--primary)]/10 text-[var(--primary)]">
                          ...
                          <div className="mt-3">
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="h-12 w-full border border-[var(--border)] bg-[var(--background)] pl-10 pr-10 text-base text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:border-[var(--primary)] focus:outline-none focus:ring-1 focus:ring-[var(--primary)]"
                              />
                              {exitSearchQuery && (
                                <button
                                  type="button"
                            ...
                            <AnimatePresence>
                              {exitSearchQuery && filteredExitAirports.length > 0 && (
                                <motion.div
                                  ...
                                  className="overflow-hidden"
                                >
                                  <div className="mt-2 max-h-48 overflow-auto border border-[var(--border)] bg-[var(--background)]">
                                    {filteredExitAirports.map((airport) => (
                                      ...
                                      >
                                        ...
                                        <span className="bg-[var(--surface)] px-2 py-0.5 text-xs font-medium text-[var(--muted-foreground)]">
                                          {airport.iataCode}
                                        </span>
                                      </button>
                                    ))}
                            ...
                            {!exitSearchQuery && (
                              <>
                                <p className="mb-2 mt-3 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)]">
                                  Popular airports
                                </p>
                                <div className="grid grid-cols-2 gap-2">
                                  {topAirports.map((airport) => (
                                    <button
                                      ...
                                      type="button"
                                      onClick={() => handleSelectExitAirport(airport)}
                                      className="group flex cursor-pointer flex-col border border-[var(--border)] bg-[var(--background)] p-3 text-left transition-all hover:border-[var(--primary)]/30"
                                    >
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    <Clock className="h-4 w-4 shrink-0 text-[var(--muted-foreground)]" />
                    <div className="flex flex-1 items-center gap-2">
                      <label className="whitespace-nowrap text-xs text-[var(--muted-foreground)]">Departing at</label>
                      <TimePickerC
          ...
          {!data.entryPoint && !isLoading && (
            ...
            >
                    ...
                    >
                      <div className="mt-2">
                        <textarea
                          ...
                          rows={3}
                          className="w-full resize-none border border-[var(--border)] bg-[var(--background)] p-3 text-base text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:border-[var(--primary)] focus:outline-none focus:ring-1 focus:ring-[var(--primary)]"
                        />
                        <button
                          type="button"
                          onClick={handleFlightParse}
                          disabled={!flightPasteText.trim()}
                          className="mt-2 bg-[var(--primary)]/10 px-4 py-2 text-sm font-bold text-[var(--primary)] transition-colors hover:bg-[var(--primary)]/20 disabled:cursor-not-allowed disabled:opacity-40"
                        >
                          Auto-fill
                        </button>
                      </div>
              ...
              {!searchQuery && (
                <>
                  <p className="mb-2 mt-4 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)]">
                    Popular airports
                  </p>
                  <div className="grid grid-cols-2 gap-2">
                    {topAirports.map((airport) => (
    ...
    >
      ...
      {!isLoading &&
        airports.map((airport) => {
          ...
          const isExit = selectedExitAirport?.iataCode === airport.iataCode;
          const isTop = topSet.has(airport.iataCode);
          const showLabel = isSelected || isExit || isTop || isZoomed;
          ...
          return (
            ...
            >
              <circle
                ...
                strokeWidth={1}
                opacity={isSelected || isExit ? 1 : 0.7}
              />
              {showLabel && (
                <text
                  x={pos.x + 7}
                  y={pos.y + 4}
                  fontSize="9"
                  fontWeight={isSelected || isExit ? "700" : "500"}
                  fill={
                    isSelected
                      ? "var(--primary)"
                      : isExit
