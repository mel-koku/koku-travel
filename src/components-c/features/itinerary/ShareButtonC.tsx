...
type ShareButtonCProps = {
  tripId: string;
};

export function ShareButtonC({ tripId }: ShareButtonCProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        disabled={isLoading}
        className={`flex h-9 items-center gap-1.5 border px-4 text-[10px] font-bold uppercase tracking-[0.15em] shrink-0 transition-colors active:scale-[0.98] ${
          share?.isActive
      ...
      {menuOpen && share?.isActive && (
        <div
          className="absolute right-0 top-full z-50 mt-2 w-64 border p-3"
          style={{
        ...
        >
          ...
          <div className="mt-3 flex flex-col gap-2">
            <button
              ...
              className="flex h-11 items-center gap-2 border px-3 text-[10px] font-bold uppercase tracking-[0.15em] transition-colors hover:bg-[color-mix(in_srgb,var(--success)_5%,transparent)] active:scale-[0.98]"
              style={{
            ...
            <button
              ...
              disabled={isLoading}
              className="flex h-11 items-center gap-2 px-3 text-[10px] font-bold uppercase tracking-[0.15em] transition-colors hover:bg-[color-mix(in_srgb,var(--foreground)_5%,transparent)]"
              style={{ color: "var(--muted-foreground)" }}
            >
