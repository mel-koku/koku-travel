...
export const FESTIVALS: readonly Festival[] = [
  ...
  // === FEBRUARY ===
  { id: "sapporo-snow", name: "Sapporo Snow Festival", nameJa: "さっぽろ雪まつり", city: "hokkaido", startMonth: 2, startDay: 4, endMonth: 2, endDay: 11, crowdImpact: 5, category: "seasonal", description: "Massive ice and snow sculptures at Odori Park", suggestedActivity: "Explore Sapporo Snow Festival ice sculptures" },
  ...
  // === MAY ===
  { id: "sanja-matsuri", name: "Sanja Matsuri", nameJa: "三社祭", city: "tokyo", startMonth: 5, startDay: 16, endMonth: 5, endDay: 18, crowdImpact: 5, category: "matsuri", description: "Tokyo's biggest festival — wild mikoshi processions around Asakusa", suggestedActivity: "Experience the energy of Sanja Matsuri in Asakusa" },
  ...
  { id: "kanda-matsuri", name: "Kanda Matsuri", nameJa: "神田祭", city: "tokyo", startMonth: 5, startDay: 10, endMonth: 5, endDay: 16, crowdImpact: 4, category: "matsuri", description: "One of Tokyo's three great festivals (odd-numbered years only)" },
  ...
  // === JUNE ===
  { id: "sanno-matsuri", name: "Sanno Matsuri", nameJa: "山王祭", city: "tokyo", startMonth: 6, startDay: 7, endMonth: 6, endDay: 17, crowdImpact: 3, category: "matsuri", description: "Grand shrine procession through central Tokyo (even years)" },
  ...
  { id: "sumida-fireworks", name: "Sumida River Fireworks", nameJa: "隅田川花火大会", city: "tokyo", startMonth: 7, startDay: 27, endMonth: 7, endDay: 27, crowdImpact: 5, category: "fireworks", description: "Tokyo's biggest fireworks show — 20,000 fireworks" },
  { id: "fuji-rock", name: "Fuji Rock Festival", nameJa: "フジロック", city: "niigata", startMonth: 7, startDay: 25, endMonth: 7, endDay: 27, crowdImpact: 3, category: "cultural", description: "Japan's premier outdoor music festival in the mountains" },
  ...
  { id: "tori-no-ichi", name: "Tori no Ichi", nameJa: "酉の市", city: "tokyo", startMonth: 11, startDay: 1, endMonth: 11, endDay: 30, crowdImpact: 3, category: "matsuri", description: "Rooster Day fair — buy ornamental kumade rakes for luck" },
  ...
  { id: "osaka-food-expo", name: "Osaka Food Expo", nameJa: "食博覧会", city: "osaka", startMonth: 4, startDay: 25, endMonth: 5, endDay: 6, crowdImpact: 3, category: "food", description: "Massive food fair during Golden Week (held every 4 years)" },

  // === Cherry Blossom Peaks (approximate, varies by year) ===
  { id: "sakura-tokyo", name: "Cherry Blossom Peak (Tokyo)", nameJa: "桜（東京）", city: "tokyo", startMonth: 3, startDay: 25, endMonth: 4, endDay: 5, crowdImpact: 4, category: "seasonal", description: "Ueno Park, Chidorigafuchi, and Meguro River packed with hanami parties", suggestedActivity: "Enjoy hanami under cherry blossoms at a Tokyo park" },
  { id: "sakura-kyoto", name: "Cherry Blossom Peak (Kyoto)", nameJa: "桜（京都）", city: "kyoto", startMonth: 3, startDay: 28, endMonth: 4, endDay: 10, crowdImpact: 5, category: "seasonal", description: "Philosopher's Path, Maruyama Park, Kiyomizu-dera — peak hanami crowds", suggestedActivity: "Walk the Philosopher's Path during cherry blossom season" },
  { id: "sakura-osaka", name: "Cherry Blossom Peak (Osaka)", nameJa: "桜（大阪）", city: "osaka", startMonth: 3, startDay: 27, endMonth: 4, endDay: 7, crowdImpact: 4, category: "seasonal", description: "Osaka Castle Park and Kema Sakuranomiya — festive hanami atmosphere" },
  { id: "sakura-hokkaido", name: "Cherry Blossom Peak (Hokkaido)", nameJa: "桜（北海道）", city: "hokkaido", startMonth: 5, startDay: 1, endMonth: 5, endDay: 15, crowdImpact: 3, category: "seasonal", description: "Late-blooming sakura at Matsumae and Goryokaku" },
] as const;
