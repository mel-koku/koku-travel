...
export const GOSHUIN_DATA: readonly GoshuinInfo[] = [
  ...
  { locationId: "byodo-in", name: "Byodo-in", nameJa: "平等院", cost: 300, notable: true, description: "Phoenix Hall. Appears on the 10-yen coin." },
  ...
  // Nagano
  { locationId: "zenko-ji", name: "Zenko-ji", nameJa: "善光寺", cost: 300, notable: true, description: "One of Japan's most visited temples. Multiple stamps available." },
