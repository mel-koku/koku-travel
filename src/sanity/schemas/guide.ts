...
export const guide = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Category",
      type: "string",
      description: "Blog post category (only for blog type)",
      options: {
        list: [
      ...
      hidden: ({ parent }) => parent?.guideType !== "blog",
    }),
    defineField({
      name: "seasons",
      title: "Seasons",
    ...
    // ── Activity-specific fields (visible only when guideType === "activity") ──
    defineField({
      name: "experienceType",
      ...
      hidden: ({ parent }) => parent?.guideType !== "activity",
    }),
    defineField({
      name: "craftType",
      title: "Craft Type",
