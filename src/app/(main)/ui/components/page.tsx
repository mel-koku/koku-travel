  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-10 py-16">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="font-serif text-4xl leading-tight text-foreground">Component Gallery</h1>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Buttons</h2>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Form Inputs</h2>
          <p className="text-sm text-foreground-secondary">
      ...
      <section className="grid gap-10 md:grid-cols-2">
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-foreground">Checkboxes</h2>
          <CheckboxGroup
            legend="Interests"
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-foreground">Radio buttons</h2>
          <RadioGroup
            legend="Pacing"
