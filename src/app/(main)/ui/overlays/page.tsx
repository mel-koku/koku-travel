  ...
  return (
    <section className="space-y-4">
      <header className="space-y-1">
        <h2 className="font-serif text-2xl text-foreground">Modal</h2>
...
function TooltipDemo() {
  return (
    <section className="space-y-4">
      <header className="space-y-1">
        <h2 className="font-serif text-2xl text-foreground">Tooltip</h2>
        <p className="text-sm text-foreground-secondary">
...
function DropdownDemo() {
  ...
  return (
    <section className="space-y-4">
      <header className="space-y-1">
        <h2 className="font-serif text-2xl text-foreground">Dropdown</h2>
        <p className="text-sm text-foreground-secondary">
...
function AlertDemo() {
  return (
    <section className="space-y-4">
      <header className="space-y-1">
        <h2 className="font-serif text-2xl text-foreground">Alerts</h2>
        <p className="text-sm text-foreground-secondary">
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-10 py-16">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="font-serif text-4xl leading-tight text-foreground">Overlay Components</h1>
