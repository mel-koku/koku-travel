  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-10 py-16">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="font-serif text-4xl leading-tight text-foreground">Card Library</h1>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Base Elements</h2>
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Activity Cards</h2>
          <p className="text-sm text-foreground-secondary">
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Location Cards</h2>
          <p className="text-sm text-foreground-secondary">
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h2 className="font-serif text-2xl text-foreground">Collection Cards</h2>
          <p className="text-sm text-foreground-secondary">
