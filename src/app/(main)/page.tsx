      ...
      <main className="flex flex-col">
        ...
        <section aria-label="Statement" className="relative bg-background">
          ...
          <div className="relative flex min-h-[50vh] items-center justify-center px-6 py-24 text-center sm:min-h-[60vh] sm:py-32">
            <p className="mx-auto max-w-3xl font-serif italic text-2xl leading-snug tracking-heading text-foreground sm:text-3xl lg:text-4xl">
        ...
        <section aria-label="Ask Koku" className="bg-canvas py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center">
              ...
              <h2 className="mx-auto mt-4 max-w-xl font-serif italic text-xl leading-snug tracking-heading text-foreground sm:text-2xl lg:text-3xl">
