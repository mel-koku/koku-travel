...
import { Wizard } from "@/components/features/_archive/trip-builder-v1/Wizard";
...
const Step1BasicInfo = dynamic(
  () =>
    import("@/components/features/_archive/trip-builder-v1/Step1BasicInfo")
...
const Step2Regions = dynamic(
  () =>
    import("@/components/features/_archive/trip-builder-v1/Step2Regions")
...
const Step3Interests = dynamic(
  () =>
    import("@/components/features/_archive/trip-builder-v1/Step3Interests")
...
const Step4Preferences = dynamic(
  () =>
    import("@/components/features/_archive/trip-builder-v1/Step4Preferences")
...
const Step5Review = dynamic(
  () =>
    import("@/components/features/_archive/trip-builder-v1/Step5Review")
