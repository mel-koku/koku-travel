...
import { ItinerarySkeletonB } from "@b/features/itinerary/ItinerarySkeletonB";
...
function ItineraryPageContent({ content }: { content?: PagesContent }) {
  ...
  if (!isMounted) {
    return (
      <div className="p-16 text-center" style={{ color: "var(--muted-foreground)" }}>
...
export function ItineraryClientB({ content }: ItineraryClientBProps) {
  return (
    <Suspense fallback={<ItinerarySkeletonB />}>
